...
if __name__ == "__main__":
    ...
    parser.add_argument('--list_all', '-l', action='store_true', help="List all PDB chain IDs and their predicted functions.")
    parser.add_argument('--protein_id', '-p', type=str, default=None, help='Example PDB chain ID to be visualized.')
    parser.add_argument('--go_id', type=str, default=None, help='Example GO term, protein chains of which are to be visualized.')
    parser.add_argument('--go_name', type=str, default=None, help='Example GO term keywordsi, protein chains of which are to be visualized.')
